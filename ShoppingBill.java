    ...
    {  
        public static void main(String args[])   
            {  
                ...
                System.out.println("\t\t\t\t\t "+"  "+"Garg Mart Grocery Shop");  
                System.out.println("\t\t\t\t\t10/63 Rajnagar, Ghaziabad, UP");  
                System.out.println("\t\t\t\t\t"  +"    " +"Opposite Metro SUbway");  
                System.out.println("GSTIN: 03AWBPP8756K592"+"\t\t\t\t\t\t\tContact: (+91) 9870995987");  
                ...
                System.out.println("Date: "+formatter.format(date)+"  "+days[calendar.get(Calendar.DAY_OF_WEEK) - 1]+"\t\t\t\t\t\t (+91) 9998779654");  
